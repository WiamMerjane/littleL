...
const WelcomeScreen = ({ navigation }) => {
  ...
  return <ScrollView style={styles.container}>
    ...
    <Text style={styles.description} >Little Lemon, Your local Mediterraniene Bistro</Text>
    <Pressable onPress={()=>{navigation.navigate("Subscribe")}} style={styles.newsletterButton}>
